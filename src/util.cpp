...
int nAnonymizeVantaurAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Vantaur
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Vantaur
    // Mac: ~/Library/Application Support/Vantaur
    // Unix: ~/.Vantaur
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Vantaur";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Vantaur.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "vantaurd.pid"));
